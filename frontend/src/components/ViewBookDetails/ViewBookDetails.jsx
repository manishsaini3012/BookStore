    ...
    <>
      ...
      {" "}
       ...
       {isLoggedIn === true && role ==="user" && ( <div className='flex flex-col  md:flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0 ' >
          ...
          <button className="bg-blue-500 rounded  mt-8 md:mt-0 lg:rounded-full  text-4xl lg:text-3xl p-3  lg:mt-8 text-white flex items-center justify-center"
          onClick={handleCart}
          >
       ...
       {isLoggedIn === true && role ==="admin" && ( <div className='flex flex-col  md:flex-row lg:flex-col items-center justify-between lg:justify-start mt-4 lg:mt-0 ' >
          ...
          <button className="bg-white rounded   mt-8 md:mt-0 lg:rounded-full  text-4xl lg:text-3xl p-3  lg:mt-8 text-red-500 flex items-center justify-center"
           onClick={deleteBook}
          >
